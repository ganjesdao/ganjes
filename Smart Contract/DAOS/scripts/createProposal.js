...
async function createProposal() {
    try {
        ...
        const proposalDeposit = await dao.PROPOSAL_DEPOSIT_AMOUNT();
        ...
        if (!requirements.canCreateProposal) {
            if (!requirements.hasAllowance) {
                ...
                const approveTx = await token.approve(daoAddress, proposalDeposit);
        ...
        if (proposalCreatedEvent) {
            ...
            console.log("  - Deposit Amount:", ethers.formatEther(proposal.proposalDeposit), "tokens");
